...
{
    printf("before sort:");    printfarr(a, n);
    int i = 0;
    int j = 0;
    int temp = 0;
    for(i = 0; i< n-1; i++)
    ...
    printf(" after sort:");    printfarr(a, n);
}
...
{
#if 0
#Test automatic storage class , lifetime is block/function
    int i = 1;
    ...
    printf("before sort:");    printfarr(arr, n);
    //bubblesort(arr, n);
    //insertsort(arr, n);
    //mergeSort(arr, 0, n-1);
    //quicksort(arr, 0, n-1);
    ...
    printf(" after sort:");    printfarr(arr, n);
